...
const LatestProperty = () => {
    ...
    const fetchProperties = async () => {
      ...
      try {
        const response = await fetch(
          "http://localhost:1000/api/v2/latestproperty",
          {
            headers: {
  ...
  return (
    <>
      <div className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 sm:py-4 lg:px-8 lg:py-8">
        <h2 className="text-3xl font-bold mb-8  mx-auto">Latest Properties</h2>
